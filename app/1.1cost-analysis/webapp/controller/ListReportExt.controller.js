sap.ui.define([
  ...
  ControllerExtension.extend('com.medicare.11costanalysis.controller.ListReportExt', {
    metadata: {
      methods: {
    ...
    override: {
      onBeforeRendering() {
        const dataModel = new JSONModel({
          Query: 'Show the top states by total Medicare paid for a bar chart.'
        });
    ...
    openDiagram() {
      ...
      if (!this._oDiagramDialog) {
        this._oDiagramDialog = Fragment.load({
          id: oView.getId(),
          name: 'com.medicare.11costanalysis.ext.fragment.UploadDiagram',
          controller: this
        }).then((oDialog) => {
