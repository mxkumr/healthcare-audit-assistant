...
sap.ui.require(
  [
    ...
    "sap/ui/qunit/qunit-junit",
    "sap/ui/qunit/qunit-coverage",
    "com/medicare/riskanalysis/test/integration/FirstJourney",
    "com/medicare/riskanalysis/test/integration/RiskScoreDistributionListJourney",
    "com/medicare/riskanalysis/test/integration/RiskScoreDistributionObjectPageJourney",
], function (QUnit) {
    "use strict";
    QUnit.start();
});
