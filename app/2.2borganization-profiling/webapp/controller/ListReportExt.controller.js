sap.ui.define([
  ...
  ControllerExtension.extend('com.medicare.22borganizationprofiling.controller.ListReportExt', {
    metadata: {
      methods: {
    ...
    override: {
      onBeforeRendering() {
        const dataModel = new JSONModel({
          Query: 'Show the highest cost per beneficiary providers by entity type for a bar chart.'
        });
    ...
    openDiagram() {
      ...
      if (!this._oDiagramDialog) {
        this._oDiagramDialog = Fragment.load({
          id: oView.getId(),
          name: 'com.medicare.22borganizationprofiling.ext.fragment.UploadDiagram',
          controller: this
        }).then((oDialog) => {
