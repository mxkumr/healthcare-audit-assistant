...
sap.ui.require(
  [
    ...
    "sap/ui/qunit/qunit-junit",
    "sap/ui/qunit/qunit-coverage",
    "com/medicare/costanalysis/test/integration/FirstJourney",
    "com/medicare/costanalysis/test/integration/CostByStateProviderTypeListJourney",
    "com/medicare/costanalysis/test/integration/CostByStateProviderTypeObjectPageJourney",
], function (QUnit) {
    "use strict";
    QUnit.start();
});
