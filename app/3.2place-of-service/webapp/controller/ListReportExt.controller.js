sap.ui.define([
  ...
  ControllerExtension.extend('com.medicare.32placeofservice.controller.ListReportExt', {
    metadata: {
      methods: {
    ...
    override: {
      onBeforeRendering() {
        const dataModel = new JSONModel({
          Query: 'Show providers with the highest average payment per service for a bar chart.'
        });
    ...
    openDiagram() {
      ...
      if (!this._oDiagramDialog) {
        this._oDiagramDialog = Fragment.load({
          id: oView.getId(),
          name: 'com.medicare.32placeofservice.ext.fragment.UploadDiagram',
          controller: this
        }).then((oDialog) => {
