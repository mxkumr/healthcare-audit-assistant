sap.ui.define([
  ...
  ControllerExtension.extend('com.medicare.22aspecialtyprofiling.controller.ListReportExt', {
    metadata: {
      methods: {
    ...
    override: {
      onBeforeRendering() {
        const dataModel = new JSONModel({
          Query: 'Show providers with the highest cost peer deviation for a bar chart.'
        });
    ...
    openDiagram() {
      ...
      if (!this._oDiagramDialog) {
        this._oDiagramDialog = Fragment.load({
          id: oView.getId(),
          name: 'com.medicare.22aspecialtyprofiling.ext.fragment.UploadDiagram',
          controller: this
        }).then((oDialog) => {
