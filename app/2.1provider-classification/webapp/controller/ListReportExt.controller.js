sap.ui.define([
  ...
  ControllerExtension.extend('com.medicare.21providerclassification.controller.ListReportExt', {
    metadata: {
      methods: {
    ...
    openDiagram() {
      ...
      if (!this._oDiagramDialog) {
        this._oDiagramDialog = Fragment.load({
          id: oView.getId(),
          name: 'com.medicare.21providerclassification.ext.fragment.UploadDiagram',
          controller: this
        }).then((oDialog) => {
