...
sap.ui.require(
  [
    ...
    "sap/ui/qunit/qunit-junit",
    "sap/ui/qunit/qunit-coverage",
    "task1costanalysis/test/integration/FirstJourney",
    "task1costanalysis/test/integration/ProviderAnalyticsListJourney",
    "task1costanalysis/test/integration/ProviderAnalyticsObjectPageJourney",
], function (QUnit) {
    "use strict";
    QUnit.start();
});
