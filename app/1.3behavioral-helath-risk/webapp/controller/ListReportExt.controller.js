sap.ui.define([
  ...
  ControllerExtension.extend('com.medicare.13behavioralhelathrisk.controller.ListReportExt', {
    metadata: {
      methods: {
    ...
    override: {
      onBeforeRendering() {
        const dataModel = new JSONModel({
          Query: 'Show specialties with the highest paid per beneficiary for a bar chart.'
        });
    ...
    openDiagram() {
      ...
      if (!this._oDiagramDialog) {
        this._oDiagramDialog = Fragment.load({
          id: oView.getId(),
          name: 'com.medicare.13behavioralhelathrisk.ext.fragment.UploadDiagram',
          controller: this
        }).then((oDialog) => {
